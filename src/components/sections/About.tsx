                ...
                >
                  ...
                  <div className="space-y-4 max-w-3xl mx-auto">
                    {[
                      ...
                      <div 
                        key={index}
                        className="flex items-center justify-center gap-4 p-4 rounded-lg bg-green-500/5 border border-green-500/20 transition-all duration-800 ease-out opacity-100 translate-x-0 text-center"
                        style={{ 
                      ...
                      >
                        ...
                        <span className="text-white/90 leading-relaxed text-base font-medium text-center flex-1">
                          {text}
                        </span>
                      </div>
                    ))}
