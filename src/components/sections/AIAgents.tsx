            ...
            <div className="relative">
                    ...
                    <div className="bg-dark-800/95 backdrop-blur-sm rounded-xl border border-dark-700/50 overflow-hidden p-5">
                      ...
                      <div className="border-t border-dark-700/50 pt-4 text-center">
                        ...
                        <p className="text-primary-400 font-medium text-sm">
                          👇 Clique no botão "Começar Agora" abaixo!
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <div className="mt-8 text-center">
                <button
                  ...
                  className="group relative font-bold py-4 px-8 rounded-lg transition-all duration-300 text-white overflow-hidden bg-gradient-to-r from-neon-pink to-primary-600 hover:from-neon-glow hover:to-primary-500 shadow-lg shadow-neon-pink/25 hover:scale-105 hover:shadow-2xl hover:shadow-neon-pink/50"
                  onMouseMove={(e) => {
